<template>
  <div class="landPage" style=" padding: 45px 0 0 0;">
    ...
    <div class="container">
      <md-card
        class="test1"
        style="margin-top:5%; padding:4vh; margin-bottom:4vh; color:white;background-color:#1ABC9C;} "
        md-with-hover
      >
        <div class="md-layout md-gutter md-alignment-center-right">
          <div class="md-layout-item">
            <h1
              style="color:#FFFFFF; font-size:250%"
            >Hello {{User.User}}! Welcome to your dashboard.</h1>
          </div>
      ...
      <div>
        <div id="DegreeProgressCard">
          ...
          <md-card
            style="height:90vh; margin-bottom:0vh; margin-top:0vh; padding:0vh; height:50vh"
            md-with-hover
          >
        ...
        <!-- <ReviewCard/> -->
        <ReviewSection :reviewData = this.reviewData />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data: function() {
    return {
      ...
      userid: 'e0123451', //to replace wth actual userid
      reviewData: [],
