<template>
  <div class="landPage" style=" padding: 40px 0 0 0;">
    ...
    <div class="container-fluid" style="width:90%">
      <md-card
        style="margin-top:5%; padding:4vh; margin-bottom:1vh; color: whitesmoke; background-color:#1ABC9C;} "
        md-with-hover
      >
        <div class="md-layout md-gutter md-alignment-center-right">
          <div class="md-layout-item">
            <h1 style="color:#FFFFFF; font-size:250%">
      ...
      <div class="md-layout md-gutter">
        ...
        <div class="md-layout-item">
          <md-card
            style="background-color:#1ABC9C;; color:whitesmoke; padding:1vh; margin-bottom:1vh"
          >
            <h1>My Reviews</h1>
          </md-card>
      ...
      <div>
        <div id="DegreeProgressCard">
          <md-card
            style="height:90vh; margin-bottom:0vh; padding:2vh; margin-top:5vh; height:50vh"
            md-with-hover
          >
...
.landPage {
  ...
  background: linear-gradient(
    ...
    rgba(176, 176, 176, 0.7959558823529411) 100%
  );
}
